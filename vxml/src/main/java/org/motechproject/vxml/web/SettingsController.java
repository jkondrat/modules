...
import org.motechproject.vxml.templates.TemplateForWeb;
...
public class SettingsController {
    ...
    @Autowired
    public SettingsController(@Qualifier("vxmlSettings") SettingsFacade settingsFacade, TemplateReader templateReader) {
