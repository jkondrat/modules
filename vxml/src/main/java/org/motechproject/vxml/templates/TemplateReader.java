...
/**
 * Reads template info from vxml-templates.json into a list of Template objects
 */
@Component
public class TemplateReader {

    public static final String FILE_NAME = "vxml-templates.json";
    private String templateFileName;
    private SettingsFacade settingsFacade;

    @Autowired
    public TemplateReader(@Qualifier("vxmlSettings") SettingsFacade settingsFacade) {
